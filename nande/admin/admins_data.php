      ...
      <p style="color: white;">Admin</p>
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item" style="border-bottom: 1px solid white;">
            ...
            <i class="fa-solid fa-user"></i>  Admins Data</a>
          </li>
          <li class="nav-item" style="border-bottom: 1px solid white;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Add Company User</h5>
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="mb-2 form-group">
        <input type="text" class="form-control" id="updatecompany"  placeholder="Company Name">
    </div>
    ...
    <div class="mb-2 form-group">
        <input type="email" class="form-control" id="updateemail"  placeholder="E-mail Address">
    </div>
